...
public class PersonalGroupTask {
ProcessEngine engine = ProcessEngines.getDefaultProcessEngine();
	...
	public void deployment(){
		Deployment deploy = engine.getRepositoryService()//获取repositoryservice
			.createDeployment().name("task3")
			.addClasspathResource("diagrams/task3.bpmn")
			.addClasspathResource("diagrams/task3.png")//部署流程资源文件BPMN/png
			.deploy();
...
//					.processDefinitionId(processDefinitionId)
	...
	public void claim(){
		...
		engine.getTaskService().setAssignee("42504", "A");
